                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.shield_outlined, color: AppStyles.textSecondary),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Сохранено'), backgroundColor: AppStyles.success),
        );
      }
    } catch (e) {
      if (mounted) {
