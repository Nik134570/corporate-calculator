...
class CalculatorRepository {
  ...
  Future<List<CalculationModel>> getTrash() async {
    final response = await _apiClient.dio.get('/calculations/trash');
    return (response.data['data'] as List).map((e) => CalculationModel.fromJson(e)).toList();
  }

  Future<CalculationModel> restore(String id) async {
    final response = await _apiClient.dio.post('/calculations/$id/restore');
    return CalculationModel.fromJson(response.data['data']);
  }
