...
import 'package:calculator/features/admin/presentation/screens/trash_screen.dart';
import 'package:calculator/features/splash/presentation/screens/splash_screen.dart';
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/admin/catalog/materials', builder: (_, __) => const MaterialsAdminScreen()),
    GoRoute(path: '/admin/catalog/product-templates', builder: (_, __) => const ProductTemplatesAdminScreen()),
    GoRoute(path: '/admin/catalog/processings', builder: (_, __) => const ProcessingsAdminScreen()),
    GoRoute(path: '/admin/catalog/piece-works', builder: (_, __) => const PieceWorksAdminScreen()),
    GoRoute(path: '/admin/catalog/discounts', builder: (_, __) => const DiscountsAdminScreen()),
    GoRoute(
    ...
    GoRoute(path: '/admin/trash', builder: (_, __) => const TrashScreen()),
  ],
);
